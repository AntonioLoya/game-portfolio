...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-mono overflow-hidden">
      ...
      <div className="fixed inset-0 bg-[url('/placeholder.svg?height=32&width=32')] bg-repeat opacity-10 pointer-events-none" />
...
Me considero una persona curiosa y siempre en constante aprendizaje, buscando nuevas maneras de combinar tecnología y creatividad para resolver problemas y mejorar la experiencia de los usuarios.
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[1, 2, 3, 4].map((project) => (
                  <div
                    key={project}
                    className="border border-green-500 p-4 rounded-lg hover:bg-green-900 transition-colors cursor-pointer"
                  >
                    <div className="h-40 bg-green-800 rounded mb-4 flex items-center justify-center">
                      <Code size={48} className="text-green-300" />
                    </div>
                    <h3 className="text-xl text-green-400 mb-2">Proyecto {project}</h3>
                    <p className="text-green-200 mb-3">
                      Descripción breve del proyecto {project}. Tecnologías utilizadas y resultados obtenidos.
                    </p>
                    <div className="flex gap-2">
                      <span className="px-2 py-1 bg-green-800 text-green-200 rounded text-xs">React</span>
                      <span className="px-2 py-1 bg-green-800 text-green-200 rounded text-xs">Node.js</span>
                      <span className="px-2 py-1 bg-green-800 text-green-200 rounded text-xs">MongoDB</span>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <footer className="mt-8 text-green-400 text-sm">
          <div className="flex justify-between items-center border-t border-green-500 pt-4">
            <div>XP: 9999 | NIVEL: 24 | MISIONES COMPLETADAS: 26</div>
            <div>© 2025 MI PORTFOLIO | TODOS LOS DERECHOS RESERVADOS</div>
          </div>
        </footer>
      </div>
    </div>
